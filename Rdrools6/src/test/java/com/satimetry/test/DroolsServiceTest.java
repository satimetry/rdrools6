...
public class DroolsServiceTest extends TestCase {
	...
	private static String MODE = "STATELESS";
	private static String INPUT_FILE_NAME = "data/input.csv";
	private static String RULES_FILE_NAME = "data/rules.drl";
...
//@Test
	public void testDataSetRules() {
		runRules(MODE, INPUT_FILE_NAME, RULES_FILE_NAME, "classDate, name, class, grade, email", "address, subject, body",
				RULES_OUTPUT);
	}

	public void runRules(String mode, String csvFile, String rulesFile, String expectedInputColumnsCSV,
		...
		try {
			...
			service = new DroolsService(mode, rules, expectedInputColumnsCSV, outputColumnsCSV);
